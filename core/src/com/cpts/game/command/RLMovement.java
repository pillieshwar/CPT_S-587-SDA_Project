...
public class RLMovement extends CommandComponent {

    ArrayList<CommandComponent> commandList = new ArrayList<CommandComponent>();

    public RLMovement(Moveable moveableEntity, float upLimit, float downLimit, float rightLimit, float leftLimit, Rectangle boundingBox){
